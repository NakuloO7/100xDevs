...
export const Navbar = ()=>{
   ...
   return (
      <div className="text-white flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4">
       ...
       <ul className="invisible md:visible flex">
        ...
        <div className={!nav ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-700 bg-[#000300] ease-in-out duration-500" : "fixed left-[-100%]"}>
